...
/**
 * The persistence utility for the normas interacionales service. This utility wraps {@link normasInteracionalesPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @generated
 */
public class normasInteracionalesUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 ...
	 */
	public static void clearCache(normasInteracionales normasInteracionales) {
		getPersistence().clearCache(normasInteracionales);
	}
	 ...
	 */
	public static List<normasInteracionales> findWithDynamicQuery(
	 ...
	 */
	public static normasInteracionales update(
		normasInteracionales normasInteracionales, boolean merge)
		throws SystemException {
		return getPersistence().update(normasInteracionales, merge);
	}
	...
	public static normasInteracionales update(
		...
		return getPersistence()
				   .update(normasInteracionales, merge, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(normasInteracionales);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(normasInteracionaleses);
	}
	...
	*/
	public static com.ability.genero.server.model.normasInteracionales create(
		int id) {
	...
	*/
	public static com.ability.genero.server.model.normasInteracionales remove(
		int id)
	...
	public static com.ability.genero.server.model.normasInteracionales updateImpl(
		com.ability.genero.server.model.normasInteracionales normasInteracionales,
		boolean merge)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(normasInteracionales, merge);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.ability.genero.server.model.normasInteracionales findByPrimaryKey(
		int id)
		throws com.ability.genero.server.NoSuchnormasInteracionalesException,
			com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.ability.genero.server.model.normasInteracionales fetchByPrimaryKey(
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.ability.genero.server.model.normasInteracionales> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static normasInteracionalesPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (normasInteracionalesPersistence)PortletBeanLocatorUtil.locate(com.ability.genero.server.service.ClpSerializer.getServletContextName(),
					normasInteracionalesPersistence.class.getName());

			ReferenceRegistry.registerReference(normasInteracionalesUtil.class,
				"_persistence");
		}
	 ...
	 * @deprecated
	 */
	public void setPersistence(normasInteracionalesPersistence persistence) {
	}

	private static normasInteracionalesPersistence _persistence;
}