...
/**
 * The persistence utility for the encuesta enfo dife service. This utility wraps {@link encuestaEnfoDifePersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @generated
 */
public class encuestaEnfoDifeUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 ...
	 */
	public static void clearCache(encuestaEnfoDife encuestaEnfoDife) {
		getPersistence().clearCache(encuestaEnfoDife);
	}
	 ...
	 */
	public static List<encuestaEnfoDife> findWithDynamicQuery(
	 ...
	 */
	public static encuestaEnfoDife update(encuestaEnfoDife encuestaEnfoDife,
		boolean merge) throws SystemException {
		return getPersistence().update(encuestaEnfoDife, merge);
	}
	...
	public static encuestaEnfoDife update(encuestaEnfoDife encuestaEnfoDife,
		...
		return getPersistence().update(encuestaEnfoDife, merge, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(encuestaEnfoDife);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(encuestaEnfoDifes);
	}
	...
	*/
	public static com.ability.genero.server.model.encuestaEnfoDife create(
		int id) {
	...
	*/
	public static com.ability.genero.server.model.encuestaEnfoDife remove(
		int id)
	...
	public static com.ability.genero.server.model.encuestaEnfoDife updateImpl(
		com.ability.genero.server.model.encuestaEnfoDife encuestaEnfoDife,
		boolean merge)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(encuestaEnfoDife, merge);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.ability.genero.server.model.encuestaEnfoDife findByPrimaryKey(
		int id)
		throws com.ability.genero.server.NoSuchencuestaEnfoDifeException,
			com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.ability.genero.server.model.encuestaEnfoDife fetchByPrimaryKey(
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.ability.genero.server.model.encuestaEnfoDife> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static encuestaEnfoDifePersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (encuestaEnfoDifePersistence)PortletBeanLocatorUtil.locate(com.ability.genero.server.service.ClpSerializer.getServletContextName(),
					encuestaEnfoDifePersistence.class.getName());

			ReferenceRegistry.registerReference(encuestaEnfoDifeUtil.class,
				"_persistence");
		}
	 ...
	 * @deprecated
	 */
	public void setPersistence(encuestaEnfoDifePersistence persistence) {
	}

	private static encuestaEnfoDifePersistence _persistence;
}