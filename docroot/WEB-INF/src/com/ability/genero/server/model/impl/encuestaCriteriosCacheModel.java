...
/**
 * The cache model class for representing encuestaCriterios in entity cache.
 *
 * @author DELL Villartech
 * @see encuestaCriterios
 * @generated
 */
public class encuestaCriteriosCacheModel implements CacheModel<encuestaCriterios>,
	Serializable {
	@Override
	...
	public encuestaCriterios toEntityModel() {
		...
		encuestaCriteriosImpl.setId(id);

		if (pregunta == null) {
			encuestaCriteriosImpl.setPregunta(StringPool.BLANK);
		}
		else {
			encuestaCriteriosImpl.setPregunta(pregunta);
		}
