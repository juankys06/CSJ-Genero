...
import com.ability.genero.server.NoSuchauditoriaException;
import com.ability.genero.server.model.auditoria;
import com.ability.genero.server.model.impl.auditoriaImpl;
import com.ability.genero.server.model.impl.auditoriaModelImpl;
...
public class auditoriaPersistenceImpl extends BasePersistenceImpl<auditoria>
	...
	protected auditoria toUnwrappedModel(auditoria auditoria) {
		...
		auditoriaImpl.setEvento(auditoria.getEvento());
		auditoriaImpl.setTabla(auditoria.getTabla());
		auditoriaImpl.setLogs(auditoria.getLogs());
		auditoriaImpl.setIdUser(auditoria.getIdUser());
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.ability.genero.server.model.auditoria")));
