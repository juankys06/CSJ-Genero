...
/**
 * The base implementation of the clase proceso local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ability.genero.server.service.impl.claseProcesoLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class claseProcesoLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements claseProcesoLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ability.genero.server.service.claseProcesoLocalServiceUtil} to access the clase proceso local service.
	 */
	...
	public claseProceso addclaseProceso(claseProceso claseProceso)
		throws SystemException {
		claseProceso.setNew(true);

		return claseProcesoPersistence.update(claseProceso, false);
	}
	 ...
	 */
	public claseProceso createclaseProceso(int id) {
		return claseProcesoPersistence.create(id);
	}
	...
	public claseProceso deleteclaseProceso(int id)
		throws PortalException, SystemException {
		return claseProcesoPersistence.remove(id);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public claseProceso deleteclaseProceso(claseProceso claseProceso)
		throws SystemException {
		return claseProcesoPersistence.remove(claseProceso);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(claseProceso.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return claseProcesoPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return claseProcesoPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public claseProceso fetchclaseProceso(int id) throws SystemException {
		return claseProcesoPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public claseProceso getclaseProceso(int id)
		throws PortalException, SystemException {
		return claseProcesoPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return claseProcesoPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<claseProceso> getclaseProcesos(int start, int end)
		throws SystemException {
		return claseProcesoPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getclaseProcesosCount() throws SystemException {
		return claseProcesoPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public claseProceso updateclaseProceso(claseProceso claseProceso)
		throws SystemException {
		return updateclaseProceso(claseProceso, true);
	}
	...
	public claseProceso updateclaseProceso(claseProceso claseProceso,
		...
		return claseProcesoPersistence.update(claseProceso, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.ability.genero.server.model.claseProceso",
			claseProcesoLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = claseProcesoPersistence.getDataSource();
	...
	private claseProcesoLocalServiceClpInvoker _clpInvoker = new claseProcesoLocalServiceClpInvoker();
}