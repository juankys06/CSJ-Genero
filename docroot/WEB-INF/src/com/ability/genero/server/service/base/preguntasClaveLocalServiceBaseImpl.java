...
/**
 * The base implementation of the preguntas clave local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ability.genero.server.service.impl.preguntasClaveLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class preguntasClaveLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements preguntasClaveLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ability.genero.server.service.preguntasClaveLocalServiceUtil} to access the preguntas clave local service.
	 */
	...
	public preguntasClave addpreguntasClave(preguntasClave preguntasClave)
		throws SystemException {
		preguntasClave.setNew(true);

		return preguntasClavePersistence.update(preguntasClave, false);
	}
	 ...
	 */
	public preguntasClave createpreguntasClave(int id) {
		return preguntasClavePersistence.create(id);
	}
	...
	public preguntasClave deletepreguntasClave(int id)
		throws PortalException, SystemException {
		return preguntasClavePersistence.remove(id);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public preguntasClave deletepreguntasClave(preguntasClave preguntasClave)
		throws SystemException {
		return preguntasClavePersistence.remove(preguntasClave);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(preguntasClave.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return preguntasClavePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return preguntasClavePersistence.countWithDynamicQuery(dynamicQuery);
	}

	public preguntasClave fetchpreguntasClave(int id) throws SystemException {
		return preguntasClavePersistence.fetchByPrimaryKey(id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public preguntasClave getpreguntasClave(int id)
		throws PortalException, SystemException {
		return preguntasClavePersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return preguntasClavePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<preguntasClave> getpreguntasClaves(int start, int end)
		throws SystemException {
		return preguntasClavePersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getpreguntasClavesCount() throws SystemException {
		return preguntasClavePersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public preguntasClave updatepreguntasClave(preguntasClave preguntasClave)
		throws SystemException {
		return updatepreguntasClave(preguntasClave, true);
	}
	...
	public preguntasClave updatepreguntasClave(preguntasClave preguntasClave,
		...
		return preguntasClavePersistence.update(preguntasClave, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.ability.genero.server.model.preguntasClave",
			preguntasClaveLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = preguntasClavePersistence.getDataSource();
	...
	private preguntasClaveLocalServiceClpInvoker _clpInvoker = new preguntasClaveLocalServiceClpInvoker();
}