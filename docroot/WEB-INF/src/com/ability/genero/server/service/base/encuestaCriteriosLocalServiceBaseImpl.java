...
/**
 * The base implementation of the encuesta criterios local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ability.genero.server.service.impl.encuestaCriteriosLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class encuestaCriteriosLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements encuestaCriteriosLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ability.genero.server.service.encuestaCriteriosLocalServiceUtil} to access the encuesta criterios local service.
	 */
	...
	public encuestaCriterios addencuestaCriterios(
		encuestaCriterios encuestaCriterios) throws SystemException {
		encuestaCriterios.setNew(true);

		return encuestaCriteriosPersistence.update(encuestaCriterios, false);
	}
	 ...
	 */
	public encuestaCriterios createencuestaCriterios(int id) {
		return encuestaCriteriosPersistence.create(id);
	}
	...
	public encuestaCriterios deleteencuestaCriterios(int id)
		throws PortalException, SystemException {
		return encuestaCriteriosPersistence.remove(id);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public encuestaCriterios deleteencuestaCriterios(
		encuestaCriterios encuestaCriterios) throws SystemException {
		return encuestaCriteriosPersistence.remove(encuestaCriterios);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(encuestaCriterios.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return encuestaCriteriosPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return encuestaCriteriosPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public encuestaCriterios fetchencuestaCriterios(int id)
		throws SystemException {
		return encuestaCriteriosPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public encuestaCriterios getencuestaCriterios(int id)
		throws PortalException, SystemException {
		return encuestaCriteriosPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return encuestaCriteriosPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<encuestaCriterios> getencuestaCriterioses(int start, int end)
		throws SystemException {
		return encuestaCriteriosPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getencuestaCriteriosesCount() throws SystemException {
		return encuestaCriteriosPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public encuestaCriterios updateencuestaCriterios(
		encuestaCriterios encuestaCriterios) throws SystemException {
		return updateencuestaCriterios(encuestaCriterios, true);
	}
	...
	public encuestaCriterios updateencuestaCriterios(
		...
		return encuestaCriteriosPersistence.update(encuestaCriterios, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.ability.genero.server.model.encuestaCriterios",
			encuestaCriteriosLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = encuestaCriteriosPersistence.getDataSource();
	...
	private encuestaCriteriosLocalServiceClpInvoker _clpInvoker = new encuestaCriteriosLocalServiceClpInvoker();
}