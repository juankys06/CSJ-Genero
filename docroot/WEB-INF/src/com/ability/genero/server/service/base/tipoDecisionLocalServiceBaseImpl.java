...
/**
 * The base implementation of the tipo decision local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ability.genero.server.service.impl.tipoDecisionLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class tipoDecisionLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements tipoDecisionLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ability.genero.server.service.tipoDecisionLocalServiceUtil} to access the tipo decision local service.
	 */
	...
	public tipoDecision addtipoDecision(tipoDecision tipoDecision)
		throws SystemException {
		tipoDecision.setNew(true);

		return tipoDecisionPersistence.update(tipoDecision, false);
	}
	 ...
	 */
	public tipoDecision createtipoDecision(int id) {
		return tipoDecisionPersistence.create(id);
	}
	...
	public tipoDecision deletetipoDecision(int id)
		throws PortalException, SystemException {
		return tipoDecisionPersistence.remove(id);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public tipoDecision deletetipoDecision(tipoDecision tipoDecision)
		throws SystemException {
		return tipoDecisionPersistence.remove(tipoDecision);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(tipoDecision.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return tipoDecisionPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return tipoDecisionPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public tipoDecision fetchtipoDecision(int id) throws SystemException {
		return tipoDecisionPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public tipoDecision gettipoDecision(int id)
		throws PortalException, SystemException {
		return tipoDecisionPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return tipoDecisionPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<tipoDecision> gettipoDecisions(int start, int end)
		throws SystemException {
		return tipoDecisionPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int gettipoDecisionsCount() throws SystemException {
		return tipoDecisionPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public tipoDecision updatetipoDecision(tipoDecision tipoDecision)
		throws SystemException {
		return updatetipoDecision(tipoDecision, true);
	}
	...
	public tipoDecision updatetipoDecision(tipoDecision tipoDecision,
		...
		return tipoDecisionPersistence.update(tipoDecision, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.ability.genero.server.model.tipoDecision",
			tipoDecisionLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = tipoDecisionPersistence.getDataSource();
	...
	private tipoDecisionLocalServiceClpInvoker _clpInvoker = new tipoDecisionLocalServiceClpInvoker();
}