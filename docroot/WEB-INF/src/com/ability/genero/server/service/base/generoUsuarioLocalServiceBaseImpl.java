...
/**
 * The base implementation of the genero usuario local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ability.genero.server.service.impl.generoUsuarioLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class generoUsuarioLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements generoUsuarioLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ability.genero.server.service.generoUsuarioLocalServiceUtil} to access the genero usuario local service.
	 */
	...
	public generoUsuario addgeneroUsuario(generoUsuario generoUsuario)
		throws SystemException {
		generoUsuario.setNew(true);

		return generoUsuarioPersistence.update(generoUsuario, false);
	}
	 ...
	 */
	public generoUsuario creategeneroUsuario(int id) {
		return generoUsuarioPersistence.create(id);
	}
	...
	public generoUsuario deletegeneroUsuario(int id)
		throws PortalException, SystemException {
		return generoUsuarioPersistence.remove(id);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public generoUsuario deletegeneroUsuario(generoUsuario generoUsuario)
		throws SystemException {
		return generoUsuarioPersistence.remove(generoUsuario);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(generoUsuario.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return generoUsuarioPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return generoUsuarioPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public generoUsuario fetchgeneroUsuario(int id) throws SystemException {
		return generoUsuarioPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public generoUsuario getgeneroUsuario(int id)
		throws PortalException, SystemException {
		return generoUsuarioPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return generoUsuarioPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<generoUsuario> getgeneroUsuarios(int start, int end)
		throws SystemException {
		return generoUsuarioPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getgeneroUsuariosCount() throws SystemException {
		return generoUsuarioPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public generoUsuario updategeneroUsuario(generoUsuario generoUsuario)
		throws SystemException {
		return updategeneroUsuario(generoUsuario, true);
	}
	...
	public generoUsuario updategeneroUsuario(generoUsuario generoUsuario,
		...
		return generoUsuarioPersistence.update(generoUsuario, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.ability.genero.server.model.generoUsuario",
			generoUsuarioLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = generoUsuarioPersistence.getDataSource();
	...
	private generoUsuarioLocalServiceClpInvoker _clpInvoker = new generoUsuarioLocalServiceClpInvoker();
}